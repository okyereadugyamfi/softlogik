...
Imports SoftLogik.Win.UI.Docking.Win32
...
Namespace UI.Docking
    Friend Class User32
        ...
        End Function
        <DllImport("User32.dll", CharSet:=CharSet.Auto)> _
        Public Shared Function DragDetect(ByVal hWnd As IntPtr, ByVal pt As UI.Docking.Win32.POINT) As Boolean
        End Function
        <DllImport("User32.dll", CharSet:=CharSet.Auto)> _
        ...
        End Function
        <DllImport("User32.dll", CharSet:=CharSet.Auto)> _
        Public Shared Function UpdateLayeredWindow(ByVal hwnd As IntPtr, ByVal hdcDst As IntPtr, ByRef pptDst As UI.Docking.Win32.POINT, ByRef psize As UI.Docking.Win32.SIZE, ByVal hdcSrc As IntPtr, ByRef pprSrc As UI.Docking.Win32.POINT, _
        ...
        End Function
        <DllImport("User32.dll", CharSet:=CharSet.Auto)> _
        Public Shared Function ClientToScreen(ByVal hWnd As IntPtr, ByRef pt As UI.Docking.Win32.POINT) As Boolean
        End Function
        <DllImport("User32.dll", CharSet:=CharSet.Auto)> _
        Public Shared Function ScreenToClient(ByVal hWnd As IntPtr, ByRef pt As UI.Docking.Win32.POINT) As Boolean
        End Function
        <DllImport("User32.dll", CharSet:=CharSet.Auto)> _
        ...
        End Function
        <DllImport("user32.dll", CharSet:=CharSet.Auto)> _
        Public Shared Function WindowFromPoint(ByVal point As UI.Docking.Win32.POINT) As IntPtr
        End Function
    End Class
End Namespace
