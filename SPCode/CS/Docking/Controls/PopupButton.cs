...
namespace SoftLogik.Win
{
	namespace UI
	{
		namespace Docking
		{
			...
			[ToolboxItem(false)]public class PopupButton : Button
			{
				...
				[Category("Appearance")]public System.Drawing.Color ActiveBackColorGradientBegin
				{
					get
					{
				...
				[Category("Appearance")]public System.Drawing.Color ActiveBackColorGradientEnd
				{
					get
					{
				...
				[Category("Appearance")]public System.Drawing.Color InactiveBackColorGradientBegin
				{
					get
					{
				...
				[Category("Appearance")]public System.Drawing.Color InactiveBackColorGradientEnd
				{
					get
					{
				...
				[Category("Appearance")]public Color BorderColor
				{
					get
					{
				...
				[Category("Appearance")][DefaultValue(1)]public int BorderWidth
				{
					get
					{
				...
				[Category("Appearance")]public Image ImageEnabled
				{
					get
					{
				...
				[Category("Appearance")]public Image ImageDisabled
				{
					get
					{
				...
				[Category("Appearance")][DefaultValue(- 1)][Editor("System.Windows.Forms.Design.ImageIndexEditor, System.Design", "System.Drawing.Design.UITypeEditor,System.Drawing")][TypeConverter(typeof(System.Windows.Forms.ImageIndexConverter))][RefreshProperties(RefreshProperties.Repaint)]public int ImageIndexEnabled
				{
					get
					{
				...
				[Category("Appearance")][DefaultValue(- 1)][Editor("System.Windows.Forms.Design.ImageIndexEditor, System.Design", "System.Drawing.Design.UITypeEditor,System.Drawing")][TypeConverter(typeof(System.Windows.Forms.ImageIndexConverter))][RefreshProperties(RefreshProperties.Repaint)]public int ImageIndexDisabled
				{
					get
					{
				...
				[Category("Appearance")][DefaultValue(false)]public bool IsPopup
				{
					get
					{
						return m_isPopup;
				...
				[Category("Appearance")][DefaultValue(true)]public bool Monochrome
				{
					get
					{
						return m_monochrom;
				...
				[Category("Behavior")][DefaultValue(false)]public bool RepeatClick
				{
					get
					{
				...
				[Category("Behavior")][DefaultValue(500)]public int RepeatClickDelay
				{
					get
					{
				...
				[Category("Behavior")][DefaultValue(100)]public int RepeatClickInterval
				{
					get
					{
				...
				[Category("Appearance")][DefaultValue("")]public string ToolTipText
				{
					get
					{
