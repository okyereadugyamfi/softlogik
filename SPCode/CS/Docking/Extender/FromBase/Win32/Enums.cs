	...
	namespace UI
	{
		namespace Docking
		{
			namespace Win32
			{
				...
				[Flags()]internal enum FlagsSetWindowPos
				{
					SWP_NOSIZE = 1,
					SWP_NOMOVE = 2,
					SWP_NOZORDER = 4,
				...
				{
					WS_OVERLAPPED = 0,
					WS_POPUP =  unchecked((int) (2147483648)),
					WS_CHILD = 1073741824,
					...
					WS_ICONIC = 536870912,
					WS_SIZEBOX = 262144,
					WS_POPUPWINDOW =  unchecked((int) (2156396544)),
				...
				internal enum TrackerEventFlags
				{
					TME_HOVER = 1,
					TME_LEAVE = 2,
					TME_QUERY = 1073741824,
					TME_CANCEL =  unchecked((int) 2147483648)
				}
				...
				internal enum SystemParametersInfoActions
				{
					GetBeep = 1,
					SetBeep = 2,
					GetMouse = 3,
				...
				[Flags()]internal enum FlagsAnimateWindow
				{
					AW_HOR_POSITIVE = 1,
					AW_HOR_NEGATIVE = 2,
					AW_VER_POSITIVE = 4,
