	...
	namespace UI
	{
		namespace Docking
		{
			namespace Win32
			{
				...
				[StructLayout(LayoutKind.Sequential)]internal struct PAINTSTRUCT
				{
					public IntPtr hdc;
					public int fErase;
				...
				[StructLayout(LayoutKind.Sequential)]internal struct TRACKMOUSEEVENTS
				{
				...
				[StructLayout(LayoutKind.Sequential)]internal struct LOGBRUSH
				{
					public UInt32 lbStyle;
					public UInt32 lbColor;
					public UInt32 lbHatch;
				}
				[StructLayout(LayoutKind.Sequential)]internal struct NCCALCSIZE_PARAMS
				{
					public RECT rgrc1;
					public RECT rgrc2;
					public RECT rgrc3;
				...
				[StructLayout(LayoutKind.Sequential)]internal struct CWPRETSTRUCT
				{
					public int lResult;
					public int lParam;
					public int wParam;
