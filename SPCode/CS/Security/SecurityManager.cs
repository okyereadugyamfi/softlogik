...
namespace SoftLogik.Win
{
	namespace Security
	{
		...
		public class SecureUser
		{
			...
			private List<SPPolicy> m_objPolicies;
			#endregion
			
			public SecureUser(string Name)
			{
				m_strName = Name;
			}
			...
			public SecureUser(string Name, string Password, List<SPPolicy> Policies)
			{
				m_strName = Name;
				m_strPassword = Password;
				m_objPolicies = Policies;
			}
			public SecureUser(List<SPPolicy> Policies)
			{
			...
			public System.Collections.Generic.List<SPPolicy> Policies
			{
				get
				{
