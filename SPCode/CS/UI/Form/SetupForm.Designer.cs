...
namespace SoftLogik.Win
{
	namespace UI
	{
		[global::Microsoft.VisualBasic.CompilerServices.DesignerGenerated()]public partial class SetupForm : RecordForm
		{
			...
			[System.Diagnostics.DebuggerStepThrough()]private void InitializeComponent()
			{
				...
				this.tvwName = new SoftLogik.Win.UI.SPTreeView();
				this.tvwName.AfterSelect += new TreeViewEventHandler(this.tvwName_AfterSelect);
				this.tbcMain = new SoftLogik.Win.UI.SPTabControl(this.components);
			...
			protected internal SoftLogik.Win.UI.SPTreeView tvwName;
			public SoftLogik.Win.UI.SPTabControl tbcMain;
