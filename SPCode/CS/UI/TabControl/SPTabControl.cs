...
namespace SoftLogik.Win
{
	namespace UI
	{
		[ToolboxBitmap(typeof(TabControl))]public partial class SPTabControl : TabControl
		{
			...
			private SPTabControlDisplayManager _DisplayManager = SPTabControlDisplayManager.Framework;
			
			#endregion
			
			#region     Properties
			
			[System.ComponentModel.DefaultValue(typeof(SPTabControlDisplayManager), "Framework"), System.ComponentModel.Category("Appearance")]public SPTabControlDisplayManager DisplayManager
			{
				get
				{
				...
				set
				{
					...
					if (this._DisplayManager.Equals(SPTabControlDisplayManager.Framework))
					{
			...
			public enum SPTabControlDisplayManager
			{
				@Default,
				Framework
			}
