...
#End Region
        ...
        ''' <param name="c"></param>
        ''' <returns></returns>
        <DefaultValue(SPTabOrderManager.TabScheme.None)> _
        Public Function GetTabScheme(ByVal c As Control) As SPTabOrderManager.TabScheme
            If Not extendees.Contains(c) Then
                Return SPTabOrderManager.TabScheme.None
            End If

            Return CType(extendees(c), SPTabOrderManager.TabScheme)
        End Function
        ...
        ''' </summary>
        ''' <param name="c"></param>
        Public Sub SetTabScheme(ByVal c As Control, ByVal val As SPTabOrderManager.TabScheme)

            If val <> SPTabOrderManager.TabScheme.None Then
                extendees(c) = val
...
#End Region
        ...
        Public Sub TopLevelForm_Load(ByVal sender As Object, ByVal e As EventArgs)
            ...
            While extendeeEnumerator.MoveNext
                ...
                Dim scheme As SPTabOrderManager.TabScheme = CType(extendeeEnumerator.Value, SPTabOrderManager.TabScheme)
