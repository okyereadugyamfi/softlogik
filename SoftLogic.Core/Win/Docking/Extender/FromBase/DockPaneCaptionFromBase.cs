...
#region Customizable Properties
		...
		protected virtual Image ImageOptionsEnabled
		{
			get
			{
				...
				{
                    _imageOptionsEnabled = Properties.Resources.DockPaneCaption_OptionsEnabled;  //ResourceHelper.LoadExtenderBitmap(_ResourceImageOptionsEnabled);
				}
		...
		protected virtual Image ImageOptionsDisabled
		{
			get
			{
				...
				{
                    _imageOptionsDisabled = Properties.Resources.DockPaneCaption_OptionsDisabled;  //ResourceHelper.LoadExtenderBitmap(_ResourceImageOptionsDisabled);
				}
		...
		protected virtual Image ImageCloseEnabled
		{
			get
			{
				...
				{
                    _imageCloseEnabled = Properties.Resources.DockPaneCaption_CloseEnabled;  //ResourceHelper.LoadExtenderBitmap(_ResourceImageCloseEnabled);
				}
		...
		protected virtual Image ImageCloseDisabled
		{
			get
			{
				...
				{
                    _imageCloseDisabled = Properties.Resources.DockPaneCaption_CloseDisabled;  //ResourceHelper.LoadExtenderBitmap(_ResourceImageCloseDisabled);
				}
		...
		protected virtual Image ImageAutoHideYes
		{
			get
			{
				...
				{
                    _imageAutoHideYes = Properties.Resources.DockPaneCaption_AutoHideYes;  //ResourceHelper.LoadExtenderBitmap(_ResourceImageAutoHideYes);
				}
		...
		protected virtual Image ImageAutoHideNo
		{
			get
			{
				...
				{
                    _imageAutoHideNo = Properties.Resources.DockPaneCaption_AutoHideNo;  //ResourceHelper.LoadExtenderBitmap(_ResourceImageAutoHideNo);
				}
		...
		protected override void OnLayout(LayoutEventArgs levent)
		{
			...
			{
				buttonWidth = System.Convert.ToInt32(buttonWidth * (height / buttonHeight));
				buttonHeight = height;
			}
