...
namespace SoftLogik.Win.UI.Controls
{
        ...
        : List<RibbonContext>
    {
        ...
        public new void AddRange(System.Collections.Generic.IEnumerable<SoftLogik.Win.UI.Controls.RibbonContext> items)
        {
        ...
        public new void Insert(int index, SoftLogik.Win.UI.Controls.RibbonContext item)
        {
            item.SetOwner(Owner);
