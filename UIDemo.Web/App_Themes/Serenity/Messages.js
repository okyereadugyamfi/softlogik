...
function RowSelected(rowObject)
{
	...
	if (rowObject.Control.className=="GridAltRowUnread_Grid SelectedRow_Grid")
	{
		...
		if (icon.toLowerCase() == "<img src=\"/app_themes/serenity/images/misc/unread.gif\">")
			this.GetCellByColumnUniqueName(rowObject,"NewIcon").innerHTML = "<img src=\"/App_Themes/Serenity/Images/Misc/Read.gif\">";
