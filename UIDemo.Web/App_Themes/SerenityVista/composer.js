...
var resizeMe = function()
{
	...
	var size = parseInt(documentObj.clientHeight) - GetScrollableSize(documentObj) - table.clientHeight - 130;
	if (size < 300)
		size = 300;
	var sizew = documentObj.clientWidth - 245;
