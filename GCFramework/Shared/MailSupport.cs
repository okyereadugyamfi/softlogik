...
namespace ACSGhana.Web.Framework
{
	...
	public class MailServices
	{
		...
		{
			SendNotification(Sender, RecipientList, "G.C.P Complaint: " + Subject, BodyText, MailPriority.High);
		}
		public static void SendQuestion(string Sender, RecipientEmails RecipientList, string Subject, string BodyText)
		{
			SendNotification(Sender, RecipientList, "G.C.P Question: " + Subject, BodyText, MailPriority.High);
		}
