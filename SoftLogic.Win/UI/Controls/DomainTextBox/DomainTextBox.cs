...
using SoftLogik.Win.Properties;
using SoftLogic.Core.Text;

[ToolboxBitmap(typeof(TextBox), "DomainTextBox")]
	...
	private void FormatText()
	{
		...
		switch(TextStyle)
		{
		    ...
		    case TextStyleEnum.Accounting:
				...
				this.Text = string.Format(this.Text, Resources.MoneyFormat);
		        break;
            case TextStyleEnum.Numeric:
		        break;
		    case TextStyleEnum.Phone:
