...
{
	internal enum PeekMessageFlags: int
	{
		PM_NOREMOVE = 0,
		PM_REMOVE = 1,
		PM_NOYIELD = 2
	...
	[Flags()]
	internal enum FlagsSetWindowPos: int
	{
		SWP_NOSIZE = 1,
		SWP_NOMOVE = 2,
		SWP_NOZORDER = 4,
	...
	internal enum SetWindowPosZ: int
	{
		HWND_TOP = 0,
		HWND_BOTTOM = 1,
		HWND_TOPMOST = -1,
	...
	internal enum MouseActivateFlags: int
	{
		MA_ACTIVATE = 1,
		MA_ACTIVATEANDEAT = 2,
		MA_NOACTIVATE = 3,
	...
	internal enum UpdateLayeredWindowsFlags: int
	{
		ULW_COLORKEY = 1,
		ULW_ALPHA = 2,
		ULW_OPAQUE = 4
	...
	internal enum RasterOperations: int
	{
		SRCCOPY = 13369376,
		SRCPAINT = 15597702,
		SRCAND = 8913094,
	...
	internal enum CombineFlags: int
	{
		RGN_AND = 1,
		RGN_OR = 2,
		RGN_XOR = 3,
	...
	internal enum SystemParametersInfoActions: int
	{
		GetBeep = 1,
		SetBeep = 2,
		GetMouse = 3,
    ...
    [Flags()]
    internal enum FlagsAnimateWindow : int
    {
        AW_HOR_POSITIVE = 1,
        AW_HOR_NEGATIVE = 2,
        AW_VER_POSITIVE = 4,
