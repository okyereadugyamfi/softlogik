...
namespace SoftLogik.Win.UI.Controls
{
    ...
    public abstract class RibbonItem : Component, IRibbonElement
    {
        ...
        internal virtual void SetSelected(bool selected)
        {
            ...
            if (selected)
            {
                OnMouseEnter(new System.Windows.Forms.MouseEventArgs(System.Windows.Forms.MouseButtons.None, 0, 0, 0, 0));
            }
            else
            {
                OnMouseLeave(new System.Windows.Forms.MouseEventArgs(System.Windows.Forms.MouseButtons.None, 0, 0, 0, 0));
            }
        }
        ...
        internal void SetCanvas(System.Windows.Forms.Control canvas)
        {
            _canvas = canvas;
        ...
        /// <param name="canvas"></param>
        private void SetCanvas(IContainsSelectableRibbonItems parent, System.Windows.Forms.Control canvas)
        {
