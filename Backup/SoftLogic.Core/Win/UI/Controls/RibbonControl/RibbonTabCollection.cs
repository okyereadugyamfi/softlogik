...
namespace SoftLogik.Win.UI.Controls
{
           ...
           : List<RibbonTab>
    {
        ...
        public new void AddRange(System.Collections.Generic.IEnumerable<SoftLogik.Win.UI.Controls.RibbonTab> items)
        {
        ...
        public new void Insert(int index, SoftLogik.Win.UI.Controls.RibbonTab item)
        {
            item.SetOwner(Owner);
