...
namespace SoftLogic.Win.Security.Support
{
    ...
    public class Hashcypher
    {
        ...
        //public static string changePassword(Form parent)
        //{
        //    // Show the changePassword dialogs but do not check the old password

        //    string sPassword = JPasswordDialog.showEditPassword(parent, "Password", "New Password", new Bitmap("password.png"));
        //    if (sPassword != null)
        //    {
        ...
        //            else
        //            {
        //                MessageBox.Show(parent, AppLocal.getIntString("message.changepassworddistinct"), AppLocal.getIntString("message.title"), JOptionPane.WARNING_MESSAGE);
        //            }
        //        }
        //    }
        ...
        //public static string changePassword(Form parent, string sOldPassword)
        //{
