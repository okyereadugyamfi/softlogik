...
namespace SoftLogik.Win.UI.Controls
{
        ...
        Component, IRibbonElement, IContainsSelectableRibbonItems, IContainsRibbonComponents
    {
        ...
        private System.Windows.Forms.Control _popUp;
        ...
        /// </summary>
        public event System.Windows.Forms.MouseEventHandler Paint;
        ...
        /// </summary>
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        internal System.Windows.Forms.Control PopUp
        {
            get { return _popUp; }
            set { _popUp = value; }
        }
        ...
        internal void SetSelected(bool selected, int mouseX, int mouseY)
        {
            ...
            if (selected)
            {
                OnMouseEnter(new System.Windows.Forms.MouseEventArgs(System.Windows.Forms.MouseButtons.None, 0, mouseX, mouseY, 0));
            }
            else
            {
                OnMouseLeave(new System.Windows.Forms.MouseEventArgs(System.Windows.Forms.MouseButtons.None, 0, mouseX, mouseY, 0));
            }
        }
        ...
        public virtual void OnMouseEnter(System.Windows.Forms.MouseEventArgs e)
        {
            if (!Enabled) return;
        ...
        /// </summary>
        /// <param name="e">Event data</param>
        public virtual void OnMouseLeave(System.Windows.Forms.MouseEventArgs e)
        {
            if (!Enabled) return;
