...
namespace SoftLogik.Win.UI.Controls
{
        ...
        : IDisposable
    {
        ...
        {
            if (!Disposed && !_suspended)
                SenseMouseMove(new System.Windows.Forms.MouseEventArgs(System.Windows.Forms.MouseButtons.None, 0, 0, 0, 0));
        }
        ...
        /// </summary>
        /// <param name="e"></param>
        public void SenseMouseDown(System.Windows.Forms.MouseEventArgs e)
        {
            if (Disposed)
                throw new ObjectDisposedException(GetType().Name);
