...
namespace SoftLogik.Win.UI.Controls
{
        ...
        : List<RibbonPanel>
    {
        ...
        public new void AddRange(System.Collections.Generic.IEnumerable<SoftLogik.Win.UI.Controls.RibbonPanel> items)
        {
        ...
        public new void Insert(int index, SoftLogik.Win.UI.Controls.RibbonPanel item)
        {
            item.SetOwner(Owner);
            item.SetOwnerTab(OwnerTab);
