...
namespace SoftLogik.Win.UI.Controls
{
        ...
        : RibbonItem
    {
        ...
        private System.Windows.Forms.TextBox _actualTextBox;
        ...
        {
            _actualTextBox = new System.Windows.Forms.TextBox();

            InitTextBox(_actualTextBox);

            _actualTextBox.TextChanged += new EventHandler(_actualTextbox_TextChanged);
            _actualTextBox.KeyDown += new System.Windows.Forms.KeyEventHandler(_actualTextbox_KeyDown);
        ...
        {
            if (!(sender as System.Windows.Forms.TextBox).Visible && !_removingTxt)
            {
                RemoveActualTextBox();
            }
        }        
        ...
        /// </summary>
        /// <param name="t"></param>
        protected virtual void InitTextBox(System.Windows.Forms.TextBox t)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void _actualTextbox_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
        {
        ...
        public override void OnMouseEnter(System.Windows.Forms.MouseEventArgs e)
        {
            if (!Enabled) return;

            base.OnMouseEnter(e);

            Canvas.Cursor = System.Windows.Forms.Cursors.IBeam;
        }

        public override void OnMouseLeave(System.Windows.Forms.MouseEventArgs e)
        {
            if (!Enabled) return;
        ...
        public override void OnMouseMove(System.Windows.Forms.MouseEventArgs e)
        {
            ...
            if (TextBoxBounds.Contains(e.X, e.Y))
            {
                Owner.Cursor = System.Windows.Forms.Cursors.IBeam;
            }
            else
            {
